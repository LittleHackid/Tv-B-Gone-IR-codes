...
const uint16_t customTimes[] PROGMEM = {
  // Longitudes de los pulsos en microsegundos
  3000,  // Encendido
  570,   // Apagado
  // Añade más tiempos si es necesario para cada pulso
};

const uint8_t customCodes[] PROGMEM = {
  // Códigos hexadecimales de los pulsos IR
  // Codificados como pares de pulsos (encendido y apagado)
  0x0, 0x6C,   // Encendido
  0x22, 0x2,   // Apagado
  0x15, 0xB,   // Encendido
  0xA, 0xD,    // Apagado
  0x1, 0x6,    // Encendido
  0x1, 0x6,    // Apagado
  // Continúa añadiendo pares de pulsos según la secuencia
};

const struct IrCode customCode PROGMEM = {
  freq_to_timerval(38000),  // Frecuencia de la señal IR en Hz
  58,                       // Número total de pares de pulsos
  2,                        // Número de bits por índice
  customTimes,              // Array de tiempos de pulsos IR
  customCodes               // Array de códigos de pulsos IR
};
